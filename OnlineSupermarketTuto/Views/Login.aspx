             ...
             <div class="col-md-4">
                <form id="form1" runat="server">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="txt" placeholder="请输入用户名"  autocomplete="off" class="form-control" runat="server" id="UNameTb"/>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3 d-grid">
                        ...
                        <asp:Button Text="登录" runat="server" CssClass="btn-success btn" ID="LoginBtn" OnClick="LoginBtn_Click"  />
                         &nbsp;
                         <asp:Button Text="注册" runat="server" CssClass="btn-success btn" ID="btnReset" OnClick="Register_Click"  />
                         &nbsp;
                         <asp:Button Text="重置" runat="server" CssClass="btn-success btn" ID="btnRegister" OnClick="Reset_Click"  />
                    </div>
                </form>
             </div>
            <div class="col-md-4">
