...
namespace blogsql.Views.Admin
{
    public partial class support : System.Web.UI.Page
    {
        ...
        private  void  ShowManufactors()
        {
            ...
            ManufactList.HeaderRow.Cells[2].Text = "生产许可证号";
            ManufactList.HeaderRow.Cells[3].Text = "产地";
        ...
        protected void EditBtn_Click1(object sender, EventArgs e)
        {
            try
            {
                if (MNameTb.Value == "" || PermNumTb.Value == "" || ManufactPlaceTb.SelectedIndex == -1)
                {
                    ErrMsg.Text = "信息缺失";
                }
                else
                {
                    ...
                    string Place = ManufactPlaceTb.DataValueField;
                    ...
                    MNameTb.Value = "";
                    PermNumTb.Value = "";
                    ManufactPlaceTb.SelectedIndex = -1;
        ...
        {
            MNameTb.Value = ManufactList.SelectedRow.Cells[1].Text;
            PermNumTb.Value = ManufactList.SelectedRow.Cells[2].Text;
            ManufactPlaceTb.SelectedValue = ManufactList.SelectedRow.Cells[3].Text;
            if(MNameTb.Value==  "")
            {
                key = 0;
        ...
        protected void DeleteBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    string MName = MNameTb.Value;
                    string PermNum = PermNumTb.Value;
                    string Place = ManufactPlaceTb.SelectedItem.ToString();
